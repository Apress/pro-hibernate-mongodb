...
public class HibernateUtil {
    ...
    static {
        try {
            ...
            cfgogm.setProperty("hibernate.ogm.mongodb.database", "hs_db");
            ...
            cfgogm.addAnnotatedClass(hogm.hnapi.entity.Players.class);
            cfgogm.addAnnotatedClass(hogm.hnapi.entity.Tournaments.class);
