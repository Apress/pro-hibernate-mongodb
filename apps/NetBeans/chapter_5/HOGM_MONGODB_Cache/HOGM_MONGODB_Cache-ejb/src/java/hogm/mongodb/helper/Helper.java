...
public class Helper {
    ...
    public static final transient String[] tnames = {"Wimbledon", "US Open", "Australian Open", "Roland Garros", "Internazionali BNL d'Italia", "BNP Paribas Open", "Costa Do Sauipe"};
    public static final transient String[] tcountries = {"United Kingdom", "U.S.A", "Australia", "France", "Italia", "U.S.A", "Brasil"};
    public static final transient String[] tsurfaces = {"grass", "hard", "hard", "clay", "clay", "hard", "indoor clay"};
    public static final transient String[] ttypes = {"grand slam", "grand slam", "grand slam", "grand slam", "ATP World Tour Masters 1000", "ATP World Tour Masters 1000", "ATP World Tour 250"};
