...
public class Helper {
    ...
    public static final transient String[] tournaments = {"Barclays ATP World Tour Finals", "Shanghai Rolex Masters", "China Open", "Coupe Rogers", "Sony Open Tennis", "BNP Paribas Open", "Aegon Championships", "Erste Bank Open",
        "Brisbane International", "Dubai Duty Free Tennis Championships", "BMW Open", "If Stockholm Open", "ABN AMRO World Tennis Tournament", "Gerry Weber Open", "Rakuten Japan Open Tennis Championships", "Open Sud de France"};
